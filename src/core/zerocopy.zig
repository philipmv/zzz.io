...
pub fn ZeroCopy(comptime T: type) type {
    return struct {
        ...
        /// or mark_written.
        pub fn get_write_area(self: *Self, size: usize) std.mem.Allocator.Error![]T {
            ...
            if (available_space >= size) {
                ...
                const new_size = std.math.ceilPowerOfTwo(usize, self.capacity + size) catch return error.OutOfMemory;
